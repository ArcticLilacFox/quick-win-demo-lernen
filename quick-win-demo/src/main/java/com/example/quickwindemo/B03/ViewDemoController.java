package com.example.quickwindemo.B03;
...
public class ViewDemoController {
    ...
    private class MyView implements View {
        ...
        @Override
        public void render(Map<String, ?> map, HttpServletRequest request, HttpServletResponse httpServletResponse) throws Exception {
